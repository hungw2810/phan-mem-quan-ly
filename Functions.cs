...
namespace testdb.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            connString = @"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = C:\Users\hungn\Desktop\Database1.mdf; Integrated Security = True; Connect Timeout = 30";
        ...
        public static DataTable GetDataToTable(string sql)
        {
            ...
            DataTable table = new DataTable(); //Khai bao table nhan du lieu tra ve 
            Mydata.Fill(table);
            return table;
        }
        ...
        public static void FillCombo(string sql, ComboBox cbo, string ma, string ten)
        {
            ...
            cbo.ValueMember = ma; // truonng gia tri
        ...
        public static bool CheckDate(string d)
        {
        ...
        public static string ChuyenSoSangChu(string sNumber)
        {
            ...
            {
                mDigit = int.Parse(sNumber.Substring(i, 1));
